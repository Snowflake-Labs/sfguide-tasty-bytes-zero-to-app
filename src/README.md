...
To understand and explore the data, you can look through the [Quickstart for Building a Data Application](https://quickstarts.snowflake.com/guide/build_a_data_app_with_snowflake/index.html?index=..%2F..index#1) that offers a number of steps to explore it.

## Create the Snowflake objects
Duration: 20

### Overview
We will now create the required objects in Snowflake to set up and run services using Snowpark Container Services.
